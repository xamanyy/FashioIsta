...
public class WomenCasualTopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_casual_top);

        recyclerView = findViewById(R.id.recylerView);

        FirebaseRecyclerOptions<WomenItems> options =
                new FirebaseRecyclerOptions.Builder<WomenItems>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("WomenCasualTop"), WomenItems.class )
                        .build();
